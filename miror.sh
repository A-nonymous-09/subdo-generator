...
clear
printf "
$r┻┳|$g―-∩       $c  [Subdomain Generator]
$r┳┻|$g　　ヽ   $y Anonymous09 
$r┻┳|$g　●   |  $y Tools Subdo Generator
$r┳┻|$g▼) _ノ   $y Github : A-nonymus-09
$r┻┳|$g￣　)
$r┳ﾐ$g(￣ ／            
$r┻┳T$g￣     
"
...
while [ $count -le $jumlah ]
do
printf "https://$RANDOM$subdo.$domain\n" >> $output
echo "[$count] Generated => $output"
sleep 000.1;
(( count++ ))
done
